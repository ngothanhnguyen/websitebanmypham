...
<form action="" autocomplete="off" method="POST">
		<table border="1"  width="100%"  align="center" class="table-login" style="text-align: center;border-collapse: collapse;">
			<tr>
				<td colspan="2" class="tieudetdmk" ><h3>Thay đổi mật khẩu</h3></td>
			</tr>
			<tr>
				<td>Tài khoản</td>
